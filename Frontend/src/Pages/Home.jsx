  ...
  return (
    <div className='flex flex-col justify-center items-center gap-12 text-center min-h-[80vh] px-4 py-12 font-outfit'>
      ...
      <div className='flex flex-col gap-8 max-w-4xl w-full'>
        ...
        {/* Corrected Table Background */}
        <div className='max-w-[800px] w-full m-auto bg-gradient-to-r from-purple-600/20 to-violet-600/20 rounded-[15px] rounded-b-none backdrop-blur-sm border-b border-[#3c3c3c]'>
          <div className="grid grid-cols-[0.7fr_1.3fr_1fr_1fr_1.5fr] gap-4 text-white/70 text-sm md:text-base font-semibold px-2 md:px-6 py-3">
  <p>#</p>
  <p>Coins</p>
  <p>Price</p>
